...
public class TodoProvider extends ContentProvider {
    ...
    static {
        ...
        sUriMatcher.addURI(TodoContract.CONTENT_AUTHORITY, TodoContract.PATH_FOCUSTIME + "/#", TODO_ID);
    }
    ...
    private Uri insertTodo(Uri uri, ContentValues values) {
        ...
        String title = values.getAsString(TodoEntry.COLUMN_TITLE);
        if (title == null) {
    ...
    private int updateTodo(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(TodoEntry.COLUMN_TITLE)) {
            String name = values.getAsString(TodoEntry.COLUMN_TITLE);
            if (name == null) {
                throw new IllegalArgumentException("Please enter title");
            }
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case TODOS:
                ...
                rowDeleted = database.delete(TodoEntry.TABLE_NAME, selection, selectionArgs);
                break;
            case TODO_ID:
