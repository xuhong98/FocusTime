...
public class NotificationUtils {
     ...
     */
    private static final int TIME_REMINDER_PENDING_INTENT_ID = 3417;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context)
                ...
                .setContentTitle(context.getString(R.string.time_reminder_notification_title))
                .setContentText(context.getString(R.string.time_reminder_notification_body))
                .setStyle(new NotificationCompat.BigTextStyle().bigText(
                        context.getString(R.string.time_reminder_notification_body)))
        ...
        notificationManager.notify(TIME_REMINDER_NOTIFICATION_ID, notificationBuilder.build());
    }
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        Intent startActivityIntent = new Intent(context, FocusModeActivity.class);
        ...
        return PendingIntent.getActivity(
                context,
                TIME_REMINDER_PENDING_INTENT_ID,
                startActivityIntent,
